...
payload2={"dpid":1, "cookie":0, "table_id":0, "idle_timeout":0,
         "hard_timeout":0,"priority":32768, "match":{"dl_dst":mac2, "in_port":4},"actions":[{"type":"OUTPUT","port":2}]
        }
payload3={"dpid":1, "cookie":0, "table_id":0, "idle_timeout":0,
         "hard_timeout":0,"priority":32768, "match":{"dl_dst":mac3, "in_port":2},"actions":[{"type":"OUTPUT","port":4}]
        }
...
payload2={"dpid":2, "cookie":0, "table_id":0, "idle_timeout":0,
...
payload2={"dpid":3, "cookie":0, "table_id":0, "idle_timeout":0,
         "hard_timeout":0,"priority":32768, "match":{"dl_dst":mac3, "in_port":3},"actions":[{"type":"OUTPUT","port":1}]
        }
